...
(function($){
	...
	$.fn.zoom = function(options) {
		...
		if(zoom.custom.zoomMode == undefined) zoom.custom.zoomMode = 'advanced';
		...
		function getUrlVars(url) {
			...
			urlBaseAndParameters = url.split("?"); 
                    //console.log("urlBaseAndParameters");
                    //console.log(urlBaseAndParameters);
		...
		function unixTimeDate(unixTime){
		...
		function deleteDivZoom(){
			$("#zoom-box").remove();
			$("#zoom-area").remove();
			$("#zoom-excluded-area-1").remove();
			$("#zoom-marker-1").remove();
			$("#zoom-marker-tooltip-1").remove();
			$("#zoom-excluded-area-2").remove();
			$("#zoom-marker-2").remove();
			$("#zoom-marker-tooltip-2").remove();			
			$("#zoom-menu").remove();			
		}		

		function updateDivZoom(){
			$("#zoom-box").attr("style","");
			$("#zoom-area").attr("style","");
			$("#zoom-excluded-area-1").attr("style","");
			$("#zoom-marker-1").attr("style","");
			$("#zoom-marker-tooltip-1").attr("style","");
			$("#zoom-excluded-area-2").attr("style","");
			$("#zoom-marker-2").attr("style","");
			$("#zoom-marker-tooltip-2").attr("style","");			
			$("#zoom-menu").attr("style","");			
		}

		/*function unixTimeDate(unixtimestamp){
		...
		function zoom_init(image) {
			console.log("FUNCTION ZOOM_INIT");
			...
			var $this = image;
			//console.log("___________");//console.log("THIS");//console.log($this);//console.log("___________");
			$this.mouseenter(
				function(){
					console.log("event mouseenter2 "+zoom.attr.activeElement);
					//console.log($this);
			...
			$this.mouseleave(
				function(){
					console.log("event mouseleave2 "+zoom.attr.activeElement);
					
					zoom.attr.activeElement = "";
					console.log(zoom);
					//deleteDivZoomUnit();
					//updateDivZoom();
					zoomElemtents_reset();
					console.log($this);
					console.log(this);
					//$(".graphimage").zoom({serverTimeOffset:-18000});
					//zoom_init(this);
					//zoomElemtents_reset();
					zoomFunction_init($this);
			...
			/*$this.mouseleave(
				function(){
					console.log("event mouseleave "+zoom.attr.activeElement);
					console.log($this);
					//updateDivZoom();					
				}
			);*/
		...
		function zoomFunction_init(image) {
			...
			$.extend(zoom.graph, getUrlVars( $this.data("parameters") ));
			...
			console.log(zoom);
			console.log("___________________________________");
			console.log("zoom.image.width:"+zoom.image.width);
			console.log("zoom.image.height:"+zoom.image.height);
			console.log("zoom.image.top:"+zoom.image.top);
			console.log("zoom.image.left:"+zoom.image.left);*/
			
			//console.log("___________________________________");
                        
			zoom.box.bottom = zoom.box.top + zoom.box.height;
			zoom.box.right	= zoom.image.left + zoom.image.width - 16;
			zoom.box.left	= zoom.box.right - zoom.graph.width;
                        
			/*console.log("zoom.box.top:"+zoom.box.top);
			console.log("zoom.box.height:"+zoom.box.height);
			console.log("zoom.image.left:"+zoom.image.left);
			console.log("zoom.image.width:"+zoom.image.width);
			console.log("zoom.box.right:"+zoom.box.right);
			console.log("zoom.graph.width:"+zoom.graph.width);                        
			console.log("___________________________________");
			console.log("bottom_box:"+zoom.box.bottom);
			console.log("right_box:"+zoom.box.right);
			console.log("left_box:"+zoom.box.left);*/
			...
			// and reposition these elements.
                        ...
                        //console.log("LLEGO AQUI ZOOM BOX");
                        
			// add the "zoomBox"
			if($("#zoom-box").length == 0) {
                                //console.log("INGRESO AQUI ZOOM BOX");
				...
				$("<div id='zoom-box' class='teamzoom'></div>").appendTo("body");
			}
                        //console.log("TERMINO AQUI ZOOM BOX");

			// add the "zoomSelectedArea"
			if($("#zoom-area").length == 0) {
				$("<div id='zoom-area' class='teamzoom'></div>").appendTo("body");
			}
                        //console.log("TERMINO AQUI ZOOM AREA");
			// add two markers for the advanced mode
			if($("#zoom-marker-1").length == 0) {
				$('<div id="zoom-excluded-area-1" class="zoom-area-excluded teamzoom"></div>').appendTo("body");
				$('<div class="zoom-marker teamzoom" id="zoom-marker-1"><div class="zoom-marker-arrow-down"></div><div class="zoom-marker-arrow-up"></div></div>').appendTo("body");
				$('<div id="zoom-marker-tooltip-1" class="zoom-marker-tooltip teamzoom"><div id="zoom-marker-tooltip-1-arrow-left" class="zoom-marker-tooltip-arrow-left"><div id="zoom-marker-tooltip-1-arrow-left-inner" class="zoom-marker-tooltip-arrow-left-inner"></div></div><span id="zoom-marker-tooltip-value-1" class="zoom-marker-tooltip-value">-</span><div id="zoom-marker-tooltip-1-arrow-right" class="zoom-marker-tooltip-arrow-right"><div id="zoom-marker-tooltip-1-arrow-right-inner" class="zoom-marker-tooltip-arrow-right-inner"></div></div></div>').appendTo('body');
			}
			if($("#zoom-marker-2").length == 0) {
				$('<div id="zoom-excluded-area-2" class="zoom-area-excluded teamzoom"></div>').appendTo("body");
				$('<div class="zoom-marker teamzoom" id="zoom-marker-2"><div class="zoom-marker-arrow-down"></div><div class="zoom-marker-arrow-up"></div></div>').appendTo("body");
				$('<div id="zoom-marker-tooltip-2" class="zoom-marker-tooltip teamzoom"><div id="zoom-marker-tooltip-2-arrow-left" class="zoom-marker-tooltip-arrow-left"><div id="zoom-marker-tooltip-1-arrow-left-inner" class="zoom-marker-tooltip-arrow-left-inner"></div></div><span id="zoom-marker-tooltip-value-2" class="zoom-marker-tooltip-value">-</span><div id="zoom-marker-tooltip-2-arrow-right" class="zoom-marker-tooltip-arrow-right"><div id="zoom-marker-tooltip-2-arrow-right-inner" class="zoom-marker-tooltip-arrow-right-inner"></div></div></div>').appendTo('body');
			}
			...
			if($("#zoom-menu").length == 0) {
				$('<div id="zoom-menu" class="zoom-menu teamzoom">'
					+ '<div class="first_li">'
		...
		*/
		function zoomAction_init(image) {
			//console.log("INGRESO:zoomAction_init");
			if(zoom.custom.zoomMode == 'quick') {
				//console.log("INGRESO:quick|"+zoom.custom.zoomMode);
				...
				///console.log("INGRESO ELSE:"+zoom.custom.zoomMode);
				/* welcome to the advanced mode ;) */
				$("#zoom-box").off("mousedown").on("mousedown", function(e) {
					//console.log("Event mousedown "+zoom.custom.zoomMode);
					//console.log(e);
					//console.log(e.which);
					switch(e.which) {
						case 1:
				...
				/*$("#zoom-box").off("mouseover").on("mouseover", function(e) {
					console.log("zoom-box mouseover");
					//updateDivZoom();
				});

				$("#zoom-box").off("mouseout").on("mouseout", function(e) {
					console.log("zoom-box mouseleave");
		...
		*/
		function zoomAction_zoom_in(){
			...
			if(zoom.options.inputfieldStartTime != '' & zoom.options.inputfieldEndTime != ''){
				...
				//filterToolbarGraf.getValue("txtFechaHastaGraf");
				//filterToolbarGraf.getValue("txtFechaHastaGraf");
				...
				/*console.log("CARGAR SELECCIONADO IN...");
				console.log(zoom);
				console.log(zoom.attr.location[0]);
				console.log("?action=" + zoom.graph.action);
				console.log("&local_graph_id=" + zoom.graph.local_graph_id);
				console.log("&rra_id=" + zoom.graph.rra_id);
				console.log("&view_type=" + zoom.graph.view_type);
				console.log("&graph_start=" + newGraphStartTime); 
				console.log("&graph_end=" + newGraphEndTime);				
				console.log("&graph_height=" + zoom.graph.height);
				console.log("&graph_width=" + zoom.graph.width);
				console.log("&type_grafic=" + zoom.graph.type_grafic);
				console.log("&title_font_size=" + zoom.graph.title_font_size);
				console.log("&newGraphStartTime="+unixTimeDate(newGraphStartTime));
				console.log("&newGraphEndTime="+unixTimeDate(newGraphEndTime));
				//console.log("&Fec_Start="+toTimestamp(newGraphStartTime));
				//console.log("&Fec_End="+toTimestamp(newGraphEndTime));*/
				
				if(zoom.graph.type_grafic=="1"){//INDIVIDUAL
					filterToolbarGraf.setValue("txtFechaDesdeGraf",unixTimeDate(newGraphStartTime));
					filterToolbarGraf.setValue("txtFechaHastaGraf",unixTimeDate(newGraphEndTime));
					viewGraficoUnit(zoom.graph.width,zoom.graph.height,unixTimeDate(newGraphStartTime),unixTimeDate(newGraphEndTime),zoom.graph.id_tablero,zoom.graph.id,zoom.graph.id_sitio_inv,false);
					deleteDivZoom();
					zoom_init(this);
				}else{//DASHBOARD
					//ACTUALIZAR DASHBOARD
					filterToolbar.setValue("txtFechaDesde",unixTimeDate(newGraphStartTime));
					filterToolbar.setValue("txtFechaHasta",unixTimeDate(newGraphEndTime)); 
					fnCrearSecciones('.containerVista',unixTimeDate(newGraphStartTime),unixTimeDate(newGraphEndTime),zoom.graph.id_tablero);
					deleteDivZoom();
					zoom_init(this);
				...
				//zoomElemtents_reset();
				//zoomContextMenu_init();
				//setTimeout(function (){zoomAction_init(zoom.initiator)},3000);
		...
		*/
		function zoomAction_zoom_out(multiplier){
			...
			if(zoom.options.inputfieldStartTime != '' & zoom.options.inputfieldEndTime != ''){
				...
				//open(zoom.attr.location[0] + "?action=" + zoom.graph.action + "&local_graph_id=" + zoom.graph.local_graph_id + "&rra_id=" + zoom.graph.rra_id + "&view_type=" + zoom.graph.view_type + "&graph_start=" + newGraphStartTime + "&graph_end=" + newGraphEndTime + "&graph_height=" + zoom.graph.height + "&graph_width=" + zoom.graph.width + "&title_font_size=" + zoom.graph.title_font_size, "_self");
				/*console.log("CARGAR SELECCIONADO OUT...");
				console.log(zoom.attr.location[0]);
				console.log("?action=" + zoom.graph.action);
				console.log("&local_graph_id=" + zoom.graph.local_graph_id);
				console.log("&rra_id=" + zoom.graph.rra_id);
				...
				console.log("&graph_width=" + zoom.graph.width);
				console.log("&title_font_size=" + zoom.graph.title_font_size);
				$(document).ready(function() { $(".graphimage").zoom({serverTimeOffset:-18000}); });*/
		...
		*/
		...
		function zoomContextMenuAction_set(object, value){
			//console.log("zoomContextMenuAction_set");
			//console.log(object);
			//console.log(value);
